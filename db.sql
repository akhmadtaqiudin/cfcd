...
-- Dumping structure for table cfd.album
...
-- Dumping data for table cfd.album: ~2 rows (approximately)
DELETE FROM `album`;
...
-- Dumping structure for table cfd.category
...
-- Dumping data for table cfd.category: 4 rows
...
-- Dumping structure for table cfd.comment
...
-- Dumping data for table cfd.comment: ~3 rows (approximately)
DELETE FROM `comment`;
...
-- Dumping structure for table cfd.component
...
-- Dumping data for table cfd.component: ~3 rows (approximately)
...
-- Dumping structure for table cfd.contact
...
-- Dumping data for table cfd.contact: ~0 rows (approximately)
DELETE FROM `contact`;
/*!40000 ALTER TABLE `contact` DISABLE KEYS */;
/*!40000 ALTER TABLE `contact` ENABLE KEYS */;


-- Dumping structure for table cfd.gallery
...
-- Dumping data for table cfd.gallery: ~6 rows (approximately)
DELETE FROM `gallery`;
...
-- Dumping structure for table cfd.media
...
-- Dumping data for table cfd.media: ~0 rows (approximately)
DELETE FROM `media`;
/*!40000 ALTER TABLE `media` DISABLE KEYS */;
/*!40000 ALTER TABLE `media` ENABLE KEYS */;


-- Dumping structure for table cfd.menu
...
-- Dumping data for table cfd.menu: 14 rows
DELETE FROM `menu`;
...
-- Dumping structure for table cfd.menu_group
...
-- Dumping data for table cfd.menu_group: 2 rows
...
-- Dumping structure for table cfd.oauth
...
-- Dumping data for table cfd.oauth: ~2 rows (approximately)
DELETE FROM `oauth`;
...
-- Dumping structure for table cfd.pages
...
-- Dumping data for table cfd.pages: ~2 rows (approximately)
DELETE FROM `pages`;
...
-- Dumping structure for table cfd.post
...
-- Dumping data for table cfd.post: ~8 rows (approximately)
DELETE FROM `post`;
...
-- Dumping structure for table cfd.setting
...
-- Dumping data for table cfd.setting: 1 rows
DELETE FROM `setting`;
...
INSERT INTO `setting` (`id_setting`, `website_name`, `website_url`, `website_email`, `meta_description`, `meta_keyword`, `favicon`, `timezone`, `website_maintenance`, `website_maintenance_tgl`, `website_cache`, `website_cache_time`, `member_register`, `template_maintenance`) VALUES
	(1, 'company', 'http://localhost/cfd', 'akhmadtaqiudin@gmail.com', 'profile', 'popojicms, website popojicms, cms indonesia, cms terbaik indonesia, cms gratis, cms gratis indonesia, alternatif cms', 'favicon.png', 'Asia/Jakarta', 'Y', '2015-11-23 00:00:00', 'N', '', 'Y', 'cool-maintenance');
/*!40000 ALTER TABLE `setting` ENABLE KEYS */;


-- Dumping structure for table cfd.subscribe
...
-- Dumping data for table cfd.subscribe: ~0 rows (approximately)
DELETE FROM `subscribe`;
/*!40000 ALTER TABLE `subscribe` DISABLE KEYS */;
/*!40000 ALTER TABLE `subscribe` ENABLE KEYS */;


-- Dumping structure for table cfd.tag
...
-- Dumping data for table cfd.tag: 30 rows
DELETE FROM `tag`;
...
-- Dumping structure for table cfd.theme
...
-- Dumping data for table cfd.theme: ~3 rows (approximately)
DELETE FROM `theme`;
/*!40000 ALTER TABLE `theme` DISABLE KEYS */;
INSERT INTO `theme` (`id_theme`, `title`, `author`, `folder`, `active`) VALUES
	(1, 'New Chingsy Theme', 'Dwira Survivor', 'newchingsy', 'N'),
	(2, 'Neon Theme', 'Dwira Survivor', 'neon', 'N'),
	(3, 'profile', 'company', 'myweb', 'Y');
/*!40000 ALTER TABLE `theme` ENABLE KEYS */;


-- Dumping structure for table cfd.traffic
...
-- Dumping data for table cfd.traffic: 3 rows
DELETE FROM `traffic`;
...
-- Dumping structure for table cfd.users
...
-- Dumping data for table cfd.users: 1 rows
DELETE FROM `users`;
...
-- Dumping structure for table cfd.user_level
...
-- Dumping data for table cfd.user_level: ~3 rows (approximately)
...
-- Dumping structure for table cfd.user_role
...
-- Dumping data for table cfd.user_role: ~42 rows (approximately)
