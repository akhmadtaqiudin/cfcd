...
-- Dumping structure for table cfcd.album
...
-- Dumping data for table cfcd.album: ~2 rows (approximately)
DELETE FROM `album`;
...
-- Dumping structure for table cfcd.category
...
-- Dumping data for table cfcd.category: 4 rows
...
-- Dumping structure for table cfcd.comment
...
-- Dumping data for table cfcd.comment: ~3 rows (approximately)
DELETE FROM `comment`;
...
-- Dumping structure for table cfcd.component
...
-- Dumping data for table cfcd.component: ~3 rows (approximately)
...
-- Dumping structure for table cfcd.contact
...
-- Dumping data for table cfcd.contact: ~0 rows (approximately)
DELETE FROM `contact`;
/*!40000 ALTER TABLE `contact` DISABLE KEYS */;
/*!40000 ALTER TABLE `contact` ENABLE KEYS */;


-- Dumping structure for table cfcd.gallery
...
-- Dumping data for table cfcd.gallery: ~6 rows (approximately)
DELETE FROM `gallery`;
...
-- Dumping structure for table cfcd.media
...
-- Dumping data for table cfcd.media: ~0 rows (approximately)
DELETE FROM `media`;
/*!40000 ALTER TABLE `media` DISABLE KEYS */;
/*!40000 ALTER TABLE `media` ENABLE KEYS */;


-- Dumping structure for table cfcd.menu
...
-- Dumping data for table cfcd.menu: 14 rows
DELETE FROM `menu`;
/*!40000 ALTER TABLE `menu` DISABLE KEYS */;
INSERT INTO `menu` (`id`, `parent_id`, `title`, `url`, `class`, `position`, `group_id`) VALUES
	(1, 0, 'HOME', './', '', 1, 1),
	(2, 0, 'ABOUT', 'pages/tentang-kami', 'dropdown', 2, 1),
	(4, 2, 'SERVICES', 'pages/layanan', '', 1, 1),
	(6, 0, 'PORTFOLIO', 'category/hubungan', '', 5, 1),
	(9, 0, 'CONTACT', 'contact', '', 8, 1),
	(10, 0, 'Home', './', '', 1, 2),
...
-- Dumping structure for table cfcd.menu_group
...
-- Dumping data for table cfcd.menu_group: 2 rows
...
-- Dumping structure for table cfcd.oauth
...
-- Dumping data for table cfcd.oauth: ~2 rows (approximately)
DELETE FROM `oauth`;
...
-- Dumping structure for table cfcd.pages
...
-- Dumping data for table cfcd.pages: ~2 rows (approximately)
DELETE FROM `pages`;
...
-- Dumping structure for table cfcd.post
...
-- Dumping data for table cfcd.post: ~8 rows (approximately)
DELETE FROM `post`;
...
-- Dumping structure for table cfcd.setting
CREATE TABLE IF NOT EXISTS `setting` (
  ...
  `website_maintenance_tgl` datetime NOT NULL,
  ...
  `template_maintenance` varchar(200) COLLATE latin1_general_ci NOT NULL DEFAULT 'Y',
  PRIMARY KEY (`id_setting`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

-- Dumping data for table cfcd.setting: 1 rows
DELETE FROM `setting`;
/*!40000 ALTER TABLE `setting` DISABLE KEYS */;
INSERT INTO `setting` (`id_setting`, `website_name`, `website_url`, `website_email`, `meta_description`, `meta_keyword`, `favicon`, `timezone`, `website_maintenance`, `website_maintenance_tgl`, `website_cache`, `website_cache_time`, `member_register`, `template_maintenance`) VALUES
	(1, 'company', 'http://localhost/cfcd', 'akhmadtaqiudin@gmail.com', 'profile', 'popojicms, website popojicms, cms indonesia, cms terbaik indonesia, cms gratis, cms gratis indonesia, alternatif cms', 'favicon.png', 'Asia/Jakarta', 'N', '0000-00-00 00:00:00', 'N', '', 'Y', 'cool-maintenance');
/*!40000 ALTER TABLE `setting` ENABLE KEYS */;


-- Dumping structure for table cfcd.subscribe
...
-- Dumping data for table cfcd.subscribe: ~0 rows (approximately)
DELETE FROM `subscribe`;
/*!40000 ALTER TABLE `subscribe` DISABLE KEYS */;
/*!40000 ALTER TABLE `subscribe` ENABLE KEYS */;


-- Dumping structure for table cfcd.tag
...
-- Dumping data for table cfcd.tag: 30 rows
DELETE FROM `tag`;
...
-- Dumping structure for table cfcd.theme
...
-- Dumping data for table cfcd.theme: ~1 rows (approximately)
DELETE FROM `theme`;
/*!40000 ALTER TABLE `theme` DISABLE KEYS */;
INSERT INTO `theme` (`id_theme`, `title`, `author`, `folder`, `active`) VALUES
	(3, 'profile', 'company', 'cfcd', 'Y');
/*!40000 ALTER TABLE `theme` ENABLE KEYS */;


-- Dumping structure for table cfcd.traffic
...
-- Dumping data for table cfcd.traffic: 4 rows
DELETE FROM `traffic`;
/*!40000 ALTER TABLE `traffic` DISABLE KEYS */;
INSERT INTO `traffic` (`ip`, `tanggal`, `hits`, `online`) VALUES
	('::1', '2015-11-03', 25, '1446540869'),
	('::1', '2015-11-17', 1, '1447743354'),
	('::1', '2015-11-18', 18, '1447823026'),
	('127.0.0.1', '2015-11-22', 10, '1448206069');
/*!40000 ALTER TABLE `traffic` ENABLE KEYS */;


-- Dumping structure for table cfcd.users
...
-- Dumping data for table cfcd.users: 1 rows
DELETE FROM `users`;
...
INSERT INTO `users` (`id_user`, `username`, `password`, `nama_lengkap`, `email`, `no_telp`, `bio`, `userpicture`, `level`, `blokir`, `id_session`, `tgl_daftar`, `forget_key`, `locktype`) VALUES
	(1, 'admin', '0192023a7bbd73250516f069df18b500', 'Administrator', 'akhmadtaqiudin@gmail.com', '08xxxxxxxxxx', 'No matter how exciting or significant a person\'s life is, a poorly written biography will make it seem like a snore. On the other hand, a good biographer can draw insight from an ordinary life-because they recognize that even the most exciting life is an ordinary life! After all, a biography isn\'t supposed to be a collection of facts assembled in chronological order; it\'s the biographer\'s interpretation of how that life was different and important.', '', '1', 'N', 'oiepcem1n401q0sg90i0fmk734', '2015-11-03', NULL, '0');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;


-- Dumping structure for table cfcd.user_level
...
-- Dumping data for table cfcd.user_level: ~3 rows (approximately)
...
-- Dumping structure for table cfcd.user_role
...
-- Dumping data for table cfcd.user_role: ~42 rows (approximately)
